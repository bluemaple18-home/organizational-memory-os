#!/usr/bin/env ruby
#
# EMEM-00：employee_memory_scope_modes / ownership_visibility_contract /
# actor_action_policy / backlog registry / policy fixtures。
# 由 validate_personal_memory_contract.rb（backward-compatible aggregator）連同
# resource / capability / recall / correction slice 一起 fail-closed 執行。
...
if failures.empty?
  puts "PASS personal memory scope contract validation"
else
